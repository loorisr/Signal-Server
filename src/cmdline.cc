...
void parse_cmdline(int argc, char *argv[])
{
    ...
    if (argc == 1) {
        ...
        spdlog::info("     -gc Random ground clutter in meters (optional, default 0)");
        spdlog::info("     -te Terrain code 1-6 (optional - 1. Water, 2. Marsh, 3. Farmland,");
        spdlog::info("          4. Mountain, 5. Desert, 6. Urban");
        spdlog::info("     -terdic Terrain dielectric value 2-80 (optional, default 15)");
        spdlog::info("     -tercon Terrain conductivity 0.01-0.0001 (optional, default 0.005)");
        ...
        spdlog::info("          (optional, default 5. Continental temperate)");
        ...
        spdlog::info("     -rt Rx Threshold (dBm / dBuV/m)");
